...
//     "start:worker": "node dist/queue/notification.worker.js",
//     "start:all": "node dist/server.js & node dist/queue/notification.worker.js",
//     "worker:dev": "ts-node src/queue/notification.worker.ts",
//     "worker_local": "nodemon src/queue/notification.worker.ts",
//     "worker": "node dist/queue/notification.worker.js",
